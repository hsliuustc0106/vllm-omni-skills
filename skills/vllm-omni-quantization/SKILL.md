...
| quack FP8 silently enables on consumer Blackwell (RTX 50-series) | `compute_capability >= 10` gate matched workstation GPUs missing `tcgen05` | fixed in #4817 — gate narrowed to `cc == 10.x` (datacenter Blackwell only) |
